...
public class ModelRequest {
     ...
     * {@link java.io.InputStream} resource for loading images.
     *
     * @param modelLoader The model loader to use.
     * @param <T> The type of the model.
     * @return A new {@link com.bumptech.glide.ModelRequest.ImageModelRequest}.
     */
     ...
     * @param modelLoader The model loader to use.
     * @param <T> The type of the model.
     * @return A new {@link com.bumptech.glide.ModelRequest.VideoModelRequest}.
     */
    ...
    /**
     * Use the {@link ModelLoaderFactory} currently registered for {@link java.io.File} to load the image represented by the
     * given {@link java.io.File}. Defaults to {@link StreamFileLoader.Factory} and {@link StreamFileLoader} to load the
     * given model.
     *
     * @see #using(StreamModelLoader)
     *
    ...
    /**
     * Use the {@link ModelLoaderFactory} currently registered for {@link java.net.URL} to load the image represented by the
     * given {@link java.net.URL}. Defaults to {@link VolleyUrlLoader.Factory} and {@link VolleyUrlLoader} to load the given
     * model.
     *
     * @see #using(StreamModelLoader)
     *
     ...
     * {@link java.io.InputStream}s and {@link ParcelFileDescriptor}s to load a thumbnail from either the image or the video
     * represented by the given model.
     *
    ...
    /**
     * A helper class for building requests with custom {@link ModelLoader}s that translate models to
     * {@link java.io.InputStream} resources for loading images.
     *
     * @param <T> The type of the model.
     */
