...
public class RecyclableBufferedInputStream extends FilterInputStream {
     ...
     * plus those available in the source stream, but see {@link java.io.InputStream#available} for
     * important caveats.
     *
     * @return the estimated number of bytes available
     * @throws java.io.IOException if this stream is closed or an error occurs
     */
    @Override
