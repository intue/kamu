...
public class Glide {
    ...
    /**
     * Returns false if the {@link com.bumptech.glide.Glide} singleton has not yet been created and can therefore be setup using
    ...
    /**
     * Creates the {@link com.bumptech.glide.Glide} singleton using the given builder. Can be used to set options like cache sizes and
     * locations.
     *
     * @see #isSetup()
     *
    ...
    /**
     * A method to build a {@link ModelLoader} for the given model that produces {@link java.io.InputStream}s using a registered
     * factory.
     *
