...
/**
 * A FIFO priority {@link java.util.concurrent.ThreadPoolExecutor} that prioritizes submitted {@link Runnable}s by assuming they implement
...
public class FifoPriorityThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    /**
     * Constructor to build a fixed thread pool with the given pool size using {@link com.bumptech.glide.load.engine.executor.FifoPriorityThreadPoolExecutor.DefaultThreadFactory}.
