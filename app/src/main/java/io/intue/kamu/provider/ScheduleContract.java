...
//import io.intue.kamu.util.AccountUtils;
import io.intue.kamu.util.ParserUtils;
...
public class ScheduleContract {
    ...
    public static final String CONTENT_AUTHORITY = "io.intue.kamu";
    ...
    public static class Tags implements TagsColumns, BaseColumns {
        ...
        /**
         * Build {@link android.net.Uri} that references all tags.
         */
        public static Uri buildTagsUri() {
            return CONTENT_URI;
        }

        /** Build a {@link android.net.Uri} that references a given tag. */
        public static Uri buildTagUri(String tagId) {
            return CONTENT_URI.buildUpon().appendPath(tagId).build();
        }

        /** Read {@link #TAG_ID} from {@link Tags} {@link android.net.Uri}. */
    ...
    public static class MySchedule implements MyScheduleColumns, BaseColumns {
        ...
        /**
         * Build {@link android.net.Uri} that references all My Schedule for the current user.
         */
    ...
    public static class Rooms implements RoomsColumns, BaseColumns {
        ...
        /**
         * Build {@link android.net.Uri} that references any {@link Sessions} associated
    ...
    public static class Feedback implements BaseColumns, FeedbackColumns, SyncColumns {
        ...
        /** Build {@link android.net.Uri} to feedback for given session. */
        public static Uri buildFeedbackUri(String sessionId) {
            return CONTENT_URI.buildUpon().appendPath(sessionId).build();
        }

        /** Read {@link #SESSION_ID} from {@link Feedback} {@link android.net.Uri}. */
    ...
    public static class Sessions implements SessionsColumns, RoomsColumns,
        ...
        /**
         * Build {@link android.net.Uri} that references any {@link Speakers} associated
        ...
        /**
         * Build {@link android.net.Uri} that references any {@link Tags} associated with
        ...
        /**
         * Build {@link android.net.Uri} that references sessions that match the query. The query can be
         * multiple words separated with spaces.
         *
         * @param query The query. Can be multiple words separated by spaces.
         * @return {@link android.net.Uri} to the sessions
         */
        ...
        /** Build {@link android.net.Uri} that references sessions in a room that have begun after the requested time **/
        ...
        /** Build {@link android.net.Uri} that references sessions not in user's schedule that happen in the specified interval **/
        ...
        /** Build {@link android.net.Uri} that references all sessions that have ALL of the indicated tags. */
        ...
        /** Build {@link android.net.Uri} that counts sessions by start/end intervals. */
    ...
    public static class Announcements implements AnnouncementsColumns, BaseColumns {
        ...
        /** Build {@link android.net.Uri} for requested {@link #ANNOUNCEMENT_ID}. */
        public static Uri buildAnnouncementUri(String announcementId) {
            return CONTENT_URI.buildUpon().appendPath(announcementId).build();
        }

        /**
         * Read {@link #ANNOUNCEMENT_ID} from {@link Announcements} {@link android.net.Uri}.
         */
    ...
    public static class MapTiles implements MapTileColumns, BaseColumns {
        ...
        /** Build {@link android.net.Uri} for all overlay zoom entries */
        public static Uri buildUri() {
            return CONTENT_URI;
        }

        /** Build {@link android.net.Uri} for requested floor. */
        public static Uri buildFloorUri(String floor) {
            return CONTENT_URI.buildUpon()
                    .appendPath(String.valueOf(floor)).build();
        }

        /** Read floor from {@link MapMarkers} {@link android.net.Uri}. */
    ...
    public static class MapMarkers implements MapMarkerColumns, BaseColumns {
        ...
        /** Read {@link #MARKER_ID} from {@link MapMarkers} {@link android.net.Uri}. */
    ...
    public static class Videos implements VideoColumns, BaseColumns {
        ...
        /** Build {@link android.net.Uri} for given video */
    ...
    public static class Experts implements ExpertsColumns, SyncColumns, BaseColumns {
        ...
        /** Build {@link android.net.Uri} for requested {@link #EXPERT_ID}. */
    ...
    public static class Partners implements PartnersColumns, SyncColumns, BaseColumns {
        ...
        /** Build {@link android.net.Uri} for requested {@link #PARTNER_ID}. */
