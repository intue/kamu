...
import io.intue.kamu.Config;
//import io.intue.kamu.appwidget.ScheduleWidgetProvider;
import io.intue.kamu.provider.ScheduleContract.*;
import io.intue.kamu.provider.ScheduleContract.Announcements;
import io.intue.kamu.provider.ScheduleContract.Blocks;
import io.intue.kamu.provider.ScheduleContract.Experts;
import io.intue.kamu.provider.ScheduleContract.Feedback;
import io.intue.kamu.provider.ScheduleContract.MapMarkers;
import io.intue.kamu.provider.ScheduleContract.MapTiles;
import io.intue.kamu.provider.ScheduleContract.PeopleIveMet;
import io.intue.kamu.provider.ScheduleContract.Rooms;
import io.intue.kamu.provider.ScheduleContract.SearchSuggest;
import io.intue.kamu.provider.ScheduleContract.Sessions;
import io.intue.kamu.provider.ScheduleContract.Speakers;
import io.intue.kamu.provider.ScheduleContract.Tags;
import io.intue.kamu.provider.ScheduleDatabase.SessionsSearchColumns;
import io.intue.kamu.provider.ScheduleDatabase.SessionsSpeakers;
import io.intue.kamu.provider.ScheduleDatabase.Tables;
 ...
 * by {@link io.intue.kamu.sync.SyncHelper}, and queried by various
